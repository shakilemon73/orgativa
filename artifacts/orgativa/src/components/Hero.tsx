    ...
    <section style={{ backgroundColor: "#FAFDF7", position: "relative", overflow: "hidden", borderBottom: "1px solid #E8F0E5" }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 48px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center", minHeight: 520, position: "relative", zIndex: 2 }}>
        ...
        <div style={{ paddingTop: 56, paddingBottom: 56 }}>
          ...
          <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 16, color: "#4A5548", maxWidth: 420, lineHeight: 1.75, margin: "0 0 32px" }}>
            বাংলাদেশের সেরা খামার থেকে হাতে বাছাই করা — কীটনাশকমুক্ত, ল্যাব-প্রত্যয়িত, তাজা পণ্য আপনার রান্নাঘরে।
          </p>

          <div style={{ display: "flex", gap: 16, marginBottom: 36, flexWrap: "wrap" }}>
            {[
              { icon: "✔", text: "কীটনাশকমুক্ত" },
              { icon: "🏅", text: "ল্যাব প্রত্যয়িত" },
      ...
      <div style={{ backgroundColor: P, padding: "11px 48px", position: "relative", zIndex: 2 }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", justifyContent: "center", gap: 48, flexWrap: "wrap" }}>
          {[
            { icon: "eco", text: "১০০% জৈব চাষ" },
            { icon: "science", text: "ল্যাব-পরীক্ষিত ও প্রত্যয়িত" },
            { icon: "local_shipping", text: "৳১,০০০+ অর্ডারে বিনামূল্যে ডেলিভারি" },
            { icon: "handshake", text: "সরাসরি কৃষকদের কাছ থেকে" },
          ].map(({ icon, text }) => (
...
function BotanicalBackground() {
  return (
    ...
    >
      ...
      <path fill="none" stroke="#2D5A27" strokeWidth="2" strokeLinecap="round" opacity="0.2" d="M 50 40 C 60 10 90 -10 130 -20" />
      <path fill="none" stroke="#2D5A27" strokeWidth="2" strokeLinecap="round" opacity="0.2" d="M 95 88 C 100 55 120 30 155 18" />
      <path fill="none" stroke="#2D5A27" strokeWidth="1.5" strokeLinecap="round" opacity="0.18" d="M 148 128 C 155 95 175 72 210 62" />
      ...
      {/* TOP-RIGHT */}
      <path fill="none" stroke="#2D5A27" strokeWidth="3" strokeLinecap="round" opacity="0.22" d="M 1310 -25 C 1240 20 1200 60 1175 110 C 1155 150 1148 180 1140 200" />
      <path fill="none" stroke="#2D5A27" strokeWidth="2" strokeLinecap="round" opacity="0.18" d="M 1248 28 C 1210 35 1180 55 1160 80" />
      <path fill="none" stroke="#2D5A27" strokeWidth="2" strokeLinecap="round" opacity="0.18" d="M 1200 72 C 1165 75 1148 95 1138 120" />
      ...
      {/* BOTTOM-LEFT */}
      <path fill="none" stroke="#2D5A27" strokeWidth="3" strokeLinecap="round" opacity="0.22" d="M -25 590 C 30 530 70 490 110 450 C 148 412 180 390 210 370" />
      <path fill="none" stroke="#2D5A27" strokeWidth="2" strokeLinecap="round" opacity="0.18" d="M 55 528 C 30 490 15 460 10 430" />
      <path fill="none" stroke="#2D5A27" strokeWidth="2" strokeLinecap="round" opacity="0.18" d="M 108 462 C 78 435 62 408 58 382" />
      ...
      {/* BOTTOM-RIGHT */}
      <path fill="none" stroke="#2D5A27" strokeWidth="3" strokeLinecap="round" opacity="0.22" d="M 1310 590 C 1245 535 1205 492 1175 452 C 1148 415 1135 385 1122 360" />
      <path fill="none" stroke="#2D5A27" strokeWidth="2" strokeLinecap="round" opacity="0.18" d="M 1238 528 C 1258 492 1270 465 1272 438" />
      <path fill="none" stroke="#2D5A27" strokeWidth="2" strokeLinecap="round" opacity="0.18" d="M 1182 468 C 1205 440 1215 415 1212 392" />
...
function TropicalLeaf({ tx, ty, rot, sc, grad }: { tx: number; ty: number; rot: number; sc: number; grad: string }) {
  ...
  const veins = [
    "M 0 -25 C -14 -30 -22 -35 -28 -42","M 0 -25 C 14 -30 22 -35 28 -42",
    "M 0 -45 C -16 -52 -25 -58 -30 -68","M 0 -45 C 16 -52 25 -58 30 -68",
    "M 0 -65 C -15 -72 -22 -80 -26 -90","M 0 -65 C 15 -72 22 -80 26 -90",
    "M 0 -83 C -10 -90 -15 -98 -16 -106","M 0 -83 C 10 -90 15 -98 16 -106",
  ];
  return (
    <g transform={`translate(${tx},${ty}) rotate(${rot}) scale(${sc})`}>
      ...
      {veins.map((v, i) => <path key={i} d={v} fill="none" stroke="#2D5A27" strokeWidth="0.6" opacity="0.2" strokeLinecap="round" />)}
    </g>
  );
}
...
function SimpleLeaf({ tx, ty, rot, sc }: { tx: number; ty: number; rot: number; sc: number }) {
  return (
    <g transform={`translate(${tx},${ty}) rotate(${rot}) scale(${sc})`}>
      ...
      <path d="M 0 0 C -10 -8 -18 -22 -16 -38 C -14 -52 -6 -60 0 -62 C 6 -60 14 -52 16 -38 C 18 -22 10 -8 0 0 Z" fill="none" stroke="#2D5A27" strokeWidth="0.7" opacity="0.28" />
